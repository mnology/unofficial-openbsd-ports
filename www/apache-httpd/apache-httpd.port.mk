# $OpenBSD: apache-httpd.port.mk
# simplify installation of apache2 modules
# written by Erik Johansen 2009, public domain
#
# how to use:
...
MODAPACHE_FINAL = /usr/local/lib/apache2/modules/${MODAPACHE_MODULE}
MODAPACHE_LOCATION ?= ${WRKBUILD}
MODAPACHE_FILE ?= ${MODAPACHE_LOCATION}/${MODAPACHE_MODULE}

APXS = /usr/local/sbin/apxs2
...
MODAPACHE_CREATE_ENABLE_SCRIPT = \
	...
	echo '    ${APXS} -i -a -n ${MODAPACHE_NAME} $${MODULE}'; \
	echo 'fi'

MODAPACHE_INSTALL= \
	${INSTALL_DATA} ${MODAPACHE_FILE} ${PREFIX}/lib/apache2/${MODAPACHE_MODULE}; \
